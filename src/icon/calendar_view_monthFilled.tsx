...
function Eoscalendar_view_monthFilled(props: iconProps) {
  return (
...
Eoscalendar_view_monthFilled.defaultProps = defaultProps;

export default Eoscalendar_view_monthFilled;
