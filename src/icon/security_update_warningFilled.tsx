...
function Eossecurity_update_warningFilled(props: iconProps) {
  return (
...
Eossecurity_update_warningFilled.defaultProps = defaultProps;

export default Eossecurity_update_warningFilled;
