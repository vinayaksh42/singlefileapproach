...
function Eossecurity_update_warningOutlined(props: iconProps) {
  return (
...
Eossecurity_update_warningOutlined.defaultProps = defaultProps;

export default Eossecurity_update_warningOutlined;
