...
function Eospanorama_photosphereOutlined(props: iconProps) {
  return (
...
Eospanorama_photosphereOutlined.defaultProps = defaultProps;

export default Eospanorama_photosphereOutlined;
