...
function Eossecurity_update_goodOutlined(props: iconProps) {
  return (
...
Eossecurity_update_goodOutlined.defaultProps = defaultProps;

export default Eossecurity_update_goodOutlined;
