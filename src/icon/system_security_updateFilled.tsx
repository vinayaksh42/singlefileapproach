...
function Eossystem_security_updateFilled(props: iconProps) {
  return (
...
Eossystem_security_updateFilled.defaultProps = defaultProps;

export default Eossystem_security_updateFilled;
