...
function Eoscancel_schedule_sendOutlined(props: iconProps) {
  return (
...
Eoscancel_schedule_sendOutlined.defaultProps = defaultProps;

export default Eoscancel_schedule_sendOutlined;
