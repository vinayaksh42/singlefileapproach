...
function Eossystem_security_update_warningOutlined(props: iconProps) {
  return (
...
Eossystem_security_update_warningOutlined.defaultProps = defaultProps;

export default Eossystem_security_update_warningOutlined;
