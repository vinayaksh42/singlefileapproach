...
function Eossystem_security_updateOutlined(props: iconProps) {
  return (
...
Eossystem_security_updateOutlined.defaultProps = defaultProps;

export default Eossystem_security_updateOutlined;
