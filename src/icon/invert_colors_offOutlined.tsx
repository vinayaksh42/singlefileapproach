...
function Eosinvert_colors_offOutlined(props: iconProps) {
  return (
...
Eosinvert_colors_offOutlined.defaultProps = defaultProps;

export default Eosinvert_colors_offOutlined;
